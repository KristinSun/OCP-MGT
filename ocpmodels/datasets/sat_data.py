...
if __name__ == "__main__":
    # 读取lmdb文件
    dataset = TrajectoryLmdbDataset({"src": "/home/xin/nyx/Graphormer-predata/examples/oc20/oc20_ni/val_id/data.lmdb"})
    l = len(dataset)

    db1 = lmdb.open(
        "/home/xin/nyx/Graphormer-predata/examples/oc20/oc20_ni/val_id/data_sat.lmdb",
